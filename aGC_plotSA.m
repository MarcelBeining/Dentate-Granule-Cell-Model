...
FontResizer
FigureResizer(5,8)
tprint(fullfile(targetfolder_results,t2n_expcat('Fig.4-SA',neuron.experiment)),'-pdf')
...
FontResizer
FigureResizer(5,8)
tprint(fullfile(targetfolder_results,t2n_expcat('Fig.4-SAfreq',neuron.experiment)),'-pdf')
