...
% nneuron{1} = blockchannel(neuron,{'except','pas','Cav32','Ca2'},100);
% nneuron{2} = blockchannel(neuron,'Cav32',100);
% nneuron{3} = blockchannel(nneuron{1},'Ca2',100,{'gncabar'});
% nneuron{4} = blockchannel(nneuron{1},'Ca2',100,{'glcabar'});

% nneuron{1} = blockchannel(neuron,{'BK','SK','na8st'},100);%blockchannel(neuron,{'except','pas','Kir21','Cav32','Ca2'},100);
nneuron{1} = blockchannel(neuron,{'except','pas','Cav22','Cav32','Cav12','Cav13'},100);
nneuron{2} = blockchannel(nneuron{1},{'Cav32'},100);
nneuron{3} = blockchannel(nneuron{1},'Cav22',100);
nneuron{4} = blockchannel(nneuron{1},{'Cav12','Cav13'},100);
nneuron{5} = blockchannel(nneuron{1},{'Cav32','Cav12','Cav13','Cav22'},100);
