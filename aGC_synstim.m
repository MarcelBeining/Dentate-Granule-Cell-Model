function aGC_synstim(params,neuron,tree,type,ostruct,targetfolder_data)
if nargin < 5
...
save(sprintf(fullfile2(targetfolder_data,'Exp_%s_%s%s%s%d.mat'),type,params.tname,str,str2,str3),'out','params','neuron','tree','indstim','recnode','thesesynids','nsyn','ppweight','freq','dd0','dt0')
