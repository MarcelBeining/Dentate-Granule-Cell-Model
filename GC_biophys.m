...
%             end    
        ...
        if on.Kv14 > 0
            vshift = 0;
            strct.axon.Kv14 = struct('gkbar',0.008*on.Kv14,'vshift',vshift); %  scale_i von 3 mˆglich um inactivatin schneller zu machen wegen kvbeta1.1
        ...
        if on.BK > 0
            ...
            strct.soma.BK = struct('gabkbar', gabk_soma,'gakbar', gak_soma,'diff',diffsoma,'base',base);  % also more gak because there might be heteromeric BKs with less than 4 ﬂ4 subunits
        end
        if on.SK > 0
            Q10 = 5;
